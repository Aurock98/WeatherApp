...
function cargarCiudad(ciudad) {
    $.getJSON(`http://api.openweathermap.org/data/2.5/weather?q=${ciudad}&APPID=faeb9fd4d7a74a5189839dc22df4d59e&units=metric&lang=en`, function (data) { //mi api en ingles 
